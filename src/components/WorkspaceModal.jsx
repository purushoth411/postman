      ...
      <div className="bg-white rounded-2xl shadow-2xl w-full max-w-lg p-8 relative max-h-[90vh] overflow-y-auto border border-gray-100">
        ...
        <div className="mb-6">
          ...
          <input
            ...
            className="w-full border border-gray-300 rounded-lg px-4 py-3 focus:ring-2 focus:ring-orange-500 focus:border-transparent outline-none transition-all bg-white shadow-sm hover:shadow"
        ...
        <div className="mb-4">
            ...
            {members.map((m, idx) => (
              <div key={idx} className="flex space-x-2 items-center">
                <input
                  ...
                  className="flex-1 border border-gray-300 rounded-lg px-3 py-2 text-sm focus:ring-2 focus:ring-orange-500 focus:border-transparent outline-none bg-white shadow-sm"
                />
                <select
                  value={m.role}
          ...
          <button 
            ...
            className="text-orange-600 text-sm font-medium mt-3 hover:text-orange-700 flex items-center space-x-1"
          >
        ...
        <div className="flex justify-between items-center mt-8 pt-6 border-t border-gray-200">
          ...
          <div className="flex space-x-3 ml-auto">
            ...
            <button
              ...
              className="px-5 py-2.5 bg-orange-500 text-white rounded-lg hover:bg-orange-600 disabled:opacity-50 disabled:cursor-not-allowed font-medium transition-all shadow-sm hover:shadow"
